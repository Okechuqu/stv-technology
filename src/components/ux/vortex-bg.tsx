...
export function VortexBackground() {
  return (
    ...
    <Vortex
      ...
      particleCount={500}
      baseHue={120}
      className="flex flex-col px-2 overflow-auto mt-[-2rem] overflow-x-hidden md:px-10  lg:pt-[6rem] md:pt-[5rem] pt-[1rem] w-screen h-screen"
    >
      <WebTechHeader />
              ...
              <div className="bg-[#014363]/[0.4] w-full flex flex-col-reverse md:flex-row lg:flex-row gap-4 py-4 px-4 rounded-xl">
                <div className="lg:w-[50rem] md:w-full lg:text-3xl md:text-sm font-bold text-dark  px-4 ">
                  <p className=" text-white">
                    At STV Web Tech, we power your business goals in the digital
                    realm
                  </p>
