const PricingBox = (props: {
  ...
  return (
    <div className="w-full">
      <div
        className="wow fadeInUp shadow-three relative z-10 rounded-sm bg-[#1D2430] px-8 py-10 hover:shadow-one"
        data-wow-delay=".1s"
      >
        <div className="flex items-center justify-between">
          <h3 className="price mb-2 text-3xl font-bold text-body-color ">
